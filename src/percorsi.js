...
function createDocumentCard(doc, index) {
    ...
    card.className = 'bg-white rounded-2xl overflow-hidden shadow-lg border-2 border-primary-100 hover:border-primary-300 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group animate-slide-in-up break-inside-avoid mb-8 will-change-transform';
